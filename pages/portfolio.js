const Portfolio = () => {
    return (
        <div className="w-full items-center flex flex-col pb-20 pt-20">
            <div className="flex flex-wrap z-30 justify-center gap-x-44 gap-y-20 lg:px-20">
                <div className="text-white font-thin text-base w-2/6">
                    <div className="text-gray-50 flex flex-col items-start">
                        <h3 className="font-normal text-3xl lg:text-5xl uppercase mt-2 mb-7">Patrick Tchinda</h3>
